...
describe('Unitely Notes', function() {
    ...
    it('Should be able to navigate to unite.ly' , () => {
        cy.visit('https://stage.unite.ly/#/') .wait(5000)
    })      
...
it('Should be Able to create new with all content' , () => {
    ...
    cy.get(':nth-child(3) > .logo').click({force: true}).wait(3000)
...
it('Should be Able to Save n Stuff' , () => {
    ...
    cy.get('.ProseMirror > p').click().type(' test')
    cy.get('#primary-menu-item-5 > .mat-list-item-content').click()
    cy.get('#confirm-dialog-confirm-btn > .mat-button-wrapper').click().wait(3000)
    cy.get('.mat-form-field-infix').click().type('test')
